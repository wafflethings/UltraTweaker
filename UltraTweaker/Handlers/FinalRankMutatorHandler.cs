...
{
    internal static class FinalRankMutatorHandler
    {
        public static Harmony harmony = new($"{UltraTweaker.GUID}.final_rank_mutator_handler");

        public static void Patch()
        {
            harmony.PatchAll(typeof(FinalRankMutatorPatches));
        }

        public class FinalRankMutatorPatches
        {
